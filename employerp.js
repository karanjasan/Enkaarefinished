...
let setprofile=()=>{
 ...
 namediv.innerHTML=firstnmae+"  "+secname.slice(0,1);
     ...
     let f =fetch("https://yielding-dented-amusement.glitch.me/enotimessprofile",options).catch(err=>{
         console.log(err)
     })
     f.then(res=>res.json()).then(d=>{
...
let f=fetch("https://yielding-dented-amusement.glitch.me/allcandidates",options).catch(err=>{
    console.log(err);
});
...
f.then(res=>res.json()).then(d=>{
    ...
    for(let i=0;i<ondiv.length;i++){
       let styled=ondiv[i];
       let inerl=styled.parentElement.parentElement.children[2].children[1].innerHTML;
    ...
    for(let i=0; i<invitebutton.length;i++){
        ...
        jobinvitbtclicked.addEventListener('click',(e)=>{
            ...
            let clickedprofileid=jobinvitbtclicked.parentElement.parentElement.firstElementChild.innerHTML;
            ...
            let f=fetch("https://yielding-dented-amusement.glitch.me/getinvitejobs",options1).catch(err=>{
                console.log(err)
            });
...
let checkempcomplete=()=>{
    let user_id=localStorage.getItem("userloged");
     ...
     let f=fetch("https://yielding-dented-amusement.glitch.me/checkepcomplete",options).catch(err=>{
        console.log(err)
    });
...
function invitesubmit(){
    ...
    if (!selectedAnswer) {
        ...
        fdata.append("job_id",darray[findIndexByValue(darray,selectedvalue)].job_id)
        ...
        let f=fetch("https://yielding-dented-amusement.glitch.me/sendinvite",options).catch(err=>{
            console.log(err)
        })
...
let eprofload =()=>{
    ...
    let f=fetch("https://yielding-dented-amusement.glitch.me/eprofiledata",options).catch(err=>{
       console.log(err);
    })
    ...
    f.then(res=>res.json()).then(d=>{
     ...
     let jf=fetch("https://yielding-dented-amusement.glitch.me/jprofilejobs",options).catch(err=>{
        console.log(err);
     })


     jf.then(res=>res.json()).then(d=>{
...
let urltoFile=(url)=>{
   ...
   let f=fetch("https://yielding-dented-amusement.glitch.me/eimageupload",options).catch(err=>{
       console.log(err);
   })
...
form.addEventListener('submit',(e)=>{
   ...
   let companysummary=document.getElementById("eabout");
    ...
    if(countr.value===""){
       ...
       let f=fetch("https://yielding-dented-amusement.glitch.me/editep",options).catch(err=>{
           console.log(err)
       })
...
let profileeditbutton=()=>{
 ...
 let f=fetch("https://yielding-dented-amusement.glitch.me/geteeditdata",options).catch(err=>{
    console.log(err);
 })
...
let f= fetch('https://yielding-dented-amusement.glitch.me/mjpost',options).catch(err =>{
       ...
       console.log(mjarray);
        ...
        for(let i=0;i<myjpostscarrierdiv.length;i++){
            ...
            clickedjobpost.addEventListener('click',()=>{
                ...
                let jobpostid=clickedjobpost.parentElement.children[0].children[0].children[1].innerHTML;
...
let f= fetch('https://yielding-dented-amusement.glitch.me/viewbids',options).catch(err =>{
     ...
     let shortlist=document.querySelectorAll(".cancelappl");
      for(let i=0; i<shortlist.length;i++){
        ...
        addtoshortlist.addEventListener('click',(e)=>{
            ...
            let value =addtoshortlist.parentElement.parentElement.parentElement.parentElement.firstElementChild.innerHTML;
            ...
            let f= fetch('https://yielding-dented-amusement.glitch.me/addshortlist',options).catch(err =>{
      ...
      for(let i=0;i<requestinterviewB.length; i++){
        ...
        clickedB.addEventListener('click',()=>{
            ...
            let cid=clickedB.parentElement.parentElement.parentElement.parentElement.firstElementChild.innerHTML;
         ...
         let f= fetch('https://yielding-dented-amusement.glitch.me/requistinterview',options).catch(err =>{
         ...
         f.then(res=>res.json()).then(d=>{
            ...
            if(res==="noallapplied"){
             ...
             mess.innerHTML="Oops! Add interview slots to be able to invite this candidate."

            }else if(res==="addmoreslots"){
                    prompt.style.display = "flex";
                    mess.innerHTML="Oops! Add more interview slots to be able to invite this candidate."
...
let f= fetch('https://yielding-dented-amusement.glitch.me/shortlist',options).catch(err =>{
...
/*
            ...
            <section class="cadabout">
                   <div class="cadaboutag">
                     <div class="startchat"><h3>About Candidate:</h3>
                     <div style="${rbackgroundC +rcoLor+rpeevents+rbColor+rcurse}" id="startcb" class="startcb">Request Interview</div>
                    </div>
                    <p id="cadaboutp">${title}</p>
                  ...
                  <div class="bidshiresec">
                    ...
                    <div class="canclejobsec">
                        ...
                        <div style="${coLor+peevents+curse}"  class="cancelappl">
                            <img src="/images/add-to-favorites.png" alt="">
                            <p>Remove</p>
...
let invites=()=>{
    ...
    while(car.hasChildNodes()){
     ...
     let f=fetch("https://yielding-dented-amusement.glitch.me/einvites",options).catch(err=>{
        console.log(err);
     }) 
...
f.then(res=>res.json()).then(d=>{
 ...
 function selectslots(){
   ...
   document.getElementsByClassName("interviewspart")[0].classList.remove("interviewspartadded");
  ...
  function selectDate(year, month, day) {
      const selectedDateTime = new Date(year, month, day, parseInt(selectedTime.split(':')[0]), parseInt(selectedTime.split(':')[1]));
      const now = new Date();
...
function addMinutesToTime(inputTime, minutesToAdd) {
  ...
  timeInput.addEventListener('input', (event) => {
      ...
      const selectedDateTime = new Date(selectedDate.getFullYear(), selectedDate.getMonth(), selectedDate.getDate(), parseInt(selectedTimeValue.split(':')[0]), parseInt(selectedTimeValue.split(':')[1]));
      ...
      if (selectedDate.getDate() === today.getDate() && selectedDate.getMonth() === today.getMonth() && selectedDate.getFullYear() === today.getFullYear()) {
          ...
          timeInputEnd.value=newTime;
              ...
              document.getElementById("wrongtime").innerHTML="You can only select current hour and minutes onwards!";
  ...
  timeInputEnd.addEventListener('input', (event) => {
      ...
      if (timeDiff >= 30 && timeDiff <= 60) {
         ...
         document.getElementById("endwarn").innerHTML="End time must be at least 30 minutes after start time.";
        ...
        document.getElementById("endwarn").innerHTML="End time cannot exceed 3 hours from start time.";
  ...
  submitButton.addEventListener('click', () => {
    if (selectedDate && selectedTime) {
        ...
        if(selectedTimeValueStart===""){
            ...
            let f=fetch("https://yielding-dented-amusement.glitch.me/interviewslots",options).catch(err=>{
               console.log(err);
             });
            timeInput.value="";
            timeInputEnd.value="";
            document.getElementsByClassName("slotsdisplay")[0].classList.add("slotdisplayadded");
            document.getElementsByClassName("slotloader")[0].classList.add("addedslotloader");

             f.then(res=>res.json()).then(d=>{
                const{five,inbetween}=d;

                if(inbetween){
                    document.getElementsByClassName("slotloader")[0].classList.remove("addedslotloader");
                  

                    document.getElementsByClassName("error-box")[0].classList.add("addederrb");
                    ...
                    document.getElementsByClassName("submitBtn")[0].classList.add("addedsBtn");
 ...
 let allinterviewslots=()=>{
    ...
    let f=fetch("https://yielding-dented-amusement.glitch.me/allintervieslots",options).catch(err=>{
       console.log(err);
     });
     document.getElementsByClassName("slotloader")[0].classList.add("addedslotloader");
        ...
        document.getElementsByClassName("slotloader")[0].classList.remove("addedslotloader");
                  ...
                  for(let i=0;i<cancelb.length;i++){
                    ...
                    clickedslot.addEventListener('click',()=>{
                      let clickedslotid=clickedslot.parentElement.parentElement.firstElementChild.innerHTML;
                    ...
                    let f=fetch("https://yielding-dented-amusement.glitch.me/deleteinslot",options2).catch(err=>{
                       console.log(err);
                     });
                     document.getElementsByClassName("slotloader")[0].classList.add("addedslotloader");
...
let interviewsl=()=>{
    ...
    document.getElementsByClassName("slotsdisplay")[0].classList.toggle("slotdisplayadded");
...
let allinterviess=()=>{
   ...
   document.getElementsByClassName("interviewspart")[0].classList.toggle("interviewspartadded");
   ...
   let f=fetch("https://yielding-dented-amusement.glitch.me/takeninterviews",options).catch(err=>{
      console.log(err);
    });
    ...
    f.then(res=>res.json()).then(d=>{
        ...
        let interviewscarrier=document.getElementsByClassName("interviewspart")[0];
...
let terminateinterviews=(interviewid)=>{
   ...
   let f=fetch("https://yielding-dented-amusement.glitch.me/terminateinterview",options).catch(err=>{
      console.log(err);
    });
      hideConfirmation();
      document.querySelector(".interviewploader").style.display="flex";
...
let interviewasums=()=>{
    ...
    let f=fetch("https://yielding-dented-amusement.glitch.me/interviewsums",options).catch(err=>{
       console.log(err);
     });
...
let shortlistsum=()=>{
    ...
    let f=fetch("https://yielding-dented-amusement.glitch.me/shortlistsum",options).catch(err=>{
       console.log(err);
     });
...
let requestintervieb=()=>{
    ...
    form.addEventListener('submit',(e)=>{
        ...
        let f=fetch("https://yielding-dented-amusement.glitch.me/enquire",options).catch(err=>{
            console.log(err);
           });
    ...
    let skcrr= document.getElementsByClassName("pcancel");
     for(let i=0;i<skcrr.length;i++){
        ...
        canceld.addEventListener('click',()=>{
            let removedarrayelment=canceld.parentElement.firstElementChild.innerHTML;
...
let ssavename=()=>{
    ...
    if(vfirsname===""){
        ...
        let formdata =new FormData()
                    ...
                    let f= fetch("https://yielding-dented-amusement.glitch.me/changeename",options).catch(err=>{
                            console.log(err)
                        })
    ...
    if (
      ...
      hasSpecialChar.test(password)
        ...
        if(passvalue !=confirmpassvalue){
           ...
           let f= fetch("https://yielding-dented-amusement.glitch.me/changeepassword",options).catch(err=>{
                   console.log(err)
               });
               passvalue="";
               confirmpassvalue=""
...
let sverifypass=()=>{
    ...
    if(password.value===""){
        ...
        let f= fetch("https://yielding-dented-amusement.glitch.me/changeemployeremail",options).catch(err=>{
            console.log(err)
        })
     loader.style.display="flex";
        f.then(res=>res.json()).then(d=>{
...
function validateEmail() {
  ...
  let settingdata=()=>{
    ...
    let f= fetch("https://yielding-dented-amusement.glitch.me/esettingdata",options).catch(err=>{
        console.log(err)
    })
